...
EVENT_AUTOMATION_REGISTERED = "automation_registered_via_oasira_ai_conversation"
EVENT_CONVERSATION_FINISHED = "oasira_ai_conversation.conversation.finished"
