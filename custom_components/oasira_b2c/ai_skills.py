"""Skill management for the Oasira AI Conversation component."""
...
from .ai_const import DEFAULT_SKILLS_DIRECTORY, DEFAULT_WORKING_DIRECTORY, SKILL_FILE_NAME
...
class SkillManager:
    """Manages skills for the Oasira AI Conversation component.
